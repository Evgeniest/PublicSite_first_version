...
add_action( 'beans_post_content_prepend_markup', 'wst_display_about' );
function wst_display_about() {
$layouts = carbon_get_the_post_meta( 'crb_about_block_layouts', 'complex' );
